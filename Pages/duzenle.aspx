<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="duzenle.aspx.cs" Inherits="ASPOrnek.Pages.duzenle" %>
...
<body onload="Msg">
    <form id="form1" runat="server">
          <div>
            <b>Merhaba Üye Duzenleme Sayfasına Hoşgeldiniz</b>
            <table id="tbl">
                <tr>
                    <td colspan="2" style="text-align:center">Üye Duzenleme Sayfası</td>
                </tr>
                <tr>
                    <td> Ad </td>
                    <td>
  ...
  <asp:RequiredFieldValidator ID="rfvAd" runat="server" ControlToValidate="txtAd" ErrorMessage="Boş geçilemez"></asp:RequiredFieldValidator>
                ...
                <tr>
                   ...
                   <tr>
                   <td colspan="2">
                       <asp:Button ID="btnDuzenle" runat="server" Text="Duzenle" OnClick="btnDuzenle_Click" />
                   </td>
                </tr> 
                <tr>
                    <td>
